...
const Home = () => {
  ...
  const copyText = () => {
    ...
    textField.innerText = 'oelkarmy@gmail.com';
  ...
  return (
    <Layout>
      <PageSection color={color}>
        <PageWrapper>
          <article>
            <h1 data-text="I'm Othmane EL karmy" className="intro__text">
              <mark className="mark">I&apos;m Othmane EL karmy</mark>
            </h1>
            <p>
              {' '}
              2nd year Software Engineer at Ensias ,{' '}
              <Link href="/projects">
                <a aria-label="">
              ...
              Developer, practicing minimalist, and{' '}
              <a
                href="https://open.spotify.com/playlist/1h0CEZCm6IbFTbxThn6Xcs?si=5b9b4f24cce34774"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="View Music Playlist"
              >
                <button type="button" tabIndex="-1">
                  Violon and classical music lover
                </button>
              </a>{' '}
              in search of flow.
            </p>
